...
f,g,h,i,j,k=e.p.colModel[a],l="",m="",n="",o="",q="",r="",t=["cn","in","eq","ne","lt","le","gt","ge","nu","nn","ni"],u=["cn","in","eq","ne","bw","bn","ew","en","nc","nu","nn","in","ni"],v=$.jgrid.getRegional(e,"search"),w=$.jgrid.styleUI[e.p.styleUI||"jQueryUI"].common;if(k){f=!(!e.p.colFilters||!e.p.colFilters[k.name])&&e.p.colFilters[k.name],f&&!$.isEmptyObject(f)&&(l=f.oper1,m=f.value1,n=f.rule,o=f.oper2,q=f.value2),k.searchoptions||(k.searchoptions={}),g=k.searchoptions.sopt?k.searchoptions.sopt:"text"===k.sorttype?u:t,h=k.searchoptions.groupOps?k.searchoptions.groupOps:v.groupOps,j=$("<form></form>");var
...
e=a.extend(!0,{filter:null,columns:[],sortStrategy:null,onChange:null,afterRedraw:null,checkValues:null,error:!1,errmsg:"",errorcheck:!0,showQuery:!0,sopt:null,ops:[],operands:null,numopts:["cn","in","eq","ne","lt","le","gt","ge","nu","nn","ni"],stropts:["cn"],strarr:["text","string","blob"],groupOps:[{op:"AND",text:"AND"},{op:"OR",text:"OR"}],groupButton:!0,ruleButtons:!0,uniqueSearchFields:!1,direction:"ltr",addsubgrup:"Add subgroup",addrule:"Add rule",delgroup:"Delete group",delrule:"Delete rule",autoencode:!1},a.jgrid.filter,b||{});return this.each(function(){if(!this.filter){this.p=e,null!==this.p.filter&&void
